...
# Build APK
export PROJECT_LOCATION="$JENKINS_HOME_HOST/workspace/$JOB_NAME"
...
appcenter distribute release --file $APK_PATH  --app sopra.mobile.bcn/69587_wearenutrition_es-android -g Collaborators